<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmStateMain.aspx.cs" Inherits="StateMngWebApp.FrmStateMain" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            Application : <asp:TextBox ID="TxtSession" runat="server"></asp:TextBox><br />
            Application : <asp:TextBox ID="TxtCache" runat="server"></asp:TextBox><br />
