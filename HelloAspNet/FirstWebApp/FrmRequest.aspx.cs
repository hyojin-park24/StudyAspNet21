...
namespace FirstWebApp
{
    public partial class FrmRequest : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            strUserId = Request.Params["TxtUserID"];//1. GET/POST 뭐든지 불러옴
            ...
            strAge = Request["TxtAge"]; //1. GET/POST 뭐든지 불러옴

            var result = $@"입력하신 아이디는 {strUserId}이고 <br/> 암호는 {strPassword}입니다.<br/>
                            이름은 {strName}이고, <br/> 나이는 {strAge} 입니다.<br/>";
