...
namespace DotNetNote.Models
{
    public class DBRepository
    {
        ...
        public DBRepository()
        {
            //Web.config에 ConnectionString 추가 
            //<connectionStrings>< add name = "ConnectionString" connectionString = " Data Source = 127.0.0.1;Initial Catalog = DotNetNote;Persist Security Info = True;User ID = sa;Password = mssql_p@ssw0rd!"providerName = "System.Data.SqlClient" /> </ connectionStrings >
